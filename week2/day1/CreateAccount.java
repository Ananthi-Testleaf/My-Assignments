...
public class CreateAccount {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//*[@id=\"accountName\"]")).sendKeys("Debit Account");
		driver.findElement(By.name("description")).sendKeys("Selenium-Automation Tester");
		driver.findElement(By.xpath("//*[@id=\"groupNameLocal\"]")).sendKeys("Ananthi");
		driver.findElement(By.xpath("//*[@id=\"officeSiteName\"]")).sendKeys("Testing");
