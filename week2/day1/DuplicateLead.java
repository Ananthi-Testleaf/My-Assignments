package week2.day1;
	...
	public class DuplicateLead {
		...
		public static void main(String[] args) {
			...
			driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Vaishnavi");
			...
			driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("ananthivaishnavi21@gmail.com");
			...
			driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Ana");
			driver.findElement(By.name("submitButton")).click();
